...
// .wrangler/tmp/bundle-sXNyKX/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\HP\\Desktop\\100xDEV\\blog-website\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\HP\\Desktop\\100xDEV\\blog-website\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// node_modules/@amankumars20/blog-website-common_new/dist/index.js
var require_dist = __commonJS({
  "node_modules/@amankumars20/blog-website-common_new/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-sXNyKX/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-sXNyKX/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/routes/user.ts
var import_blog_website_common_new = __toESM(require_dist());
var userRouter = new Hono2();
userRouter.post("/signup", async (c) => {
  const body = await c.req.json();
  const { success } = import_blog_website_common_new.signupInput.safeParse(body);
  if (!success) {
    c.status(403);
    return c.json(
      {
